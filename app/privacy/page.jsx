            ...
            <div className="separatePage">
                <div className={styles.section}>
                    ...
                    <p className={styles.content}>
                        lucktime의 본 개인정보처리방침은 개인정보보호법에 따라 lucktime 내에서의 이용자의 개인정보 처리
                        현황을 최대한 알기 쉽고 상세하게 설명하기 위해 노력하였습니다. 개인정보처리방침을 개정하는 경우
                        웹사이트 공지사항을 통하여 공지할 것입니다.
                    </p>
                ...
                <div className={styles.section}>
                    ...
                    <p className={styles.content}>
                        ...
                        등 대부분의 lucktime 서비스를 회원과 동일하게 이용할 수 있습니다. 선착순 이벤트 즐겨찾기 등과
                        같은 개인화 서비스를 이용하기 위해 회원가입을 할 경우, lucktime은 서비스 이용을 위해 필요한
                        최소한의 개인정보를 수집합니다. 회원가입 시 lucktime 이용자로부터 필수항목으로 수집하는
                        개인정보는 아래와 같습니다.
                    </p>
                ...
                <div className={styles.section}>
                    ...
                    <p className={styles.content}>
                        lucktime에서는 회원 관리, 서비스 제공, 혜택 제공, 이용 안내 등 아래의 목적으로만 개인정보를
                        이용합니다.
                    </p>
                    <ul className={styles.list}>
                        ...
                        <li className={styles.listitem}>혜택 제공: lucktime 회원 전용 자체 이벤트 참여기회 제공 등</li>
                ...
                <div className={styles.section}>
                    ...
                    <p className={styles.content}>
                        lucktime은 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의 받은
                ...
                <div className={styles.section}>
                    ...
                    <p className={styles.content}>
                        lucktime은 이용자 동의 없이 개인정보를 외부에 제공하지 않습니다. 암호화하여 안전하게 보관합니다.
                    </p>
                </div>
                <div className={styles.section}>
